                ...
                <form action="{{route('crud.store')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('name') is-invalid @enderror" id="exampleInputEmail1" name="name" placeholder="Enter Name">
                      @error('name')
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword1">Adress</label>
                        <textarea type="password" rows="5" name="description" class="form-control" id="exampleInputPassword1" placeholder="Enter desription"></textarea>
                      </div>
                  </div>
                  <!-- /.card-body -->
